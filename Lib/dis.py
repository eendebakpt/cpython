...
LOAD_FAST_ADD_STORE_FAST = opmap['LOAD_FAST_ADD_STORE_FAST']  # TOS-cache spike
IS_OP = opmap['IS_OP']
...
class ArgResolver:
    ...
    def get_argval_argrepr(self, op, arg, offset):
        ...
        if arg is not None:
            ...
            elif deop in (LOAD_FAST_LOAD_FAST, LOAD_FAST_BORROW_LOAD_FAST_BORROW, STORE_FAST_LOAD_FAST, STORE_FAST_STORE_FAST, LOAD_FAST_ADD_STORE_FAST):
                arg1 = arg >> 4
                arg2 = arg & 15
