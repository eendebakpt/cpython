...
_specialized_opmap = frozendict(
    ...
    BINARY_SLICE_JIT=144,
    CALL_ALLOC_AND_ENTER_INIT=145,
    CALL_BOUND_METHOD_EXACT_ARGS=146,
    CALL_BOUND_METHOD_GENERAL=147,
    CALL_BUILTIN_CLASS=148,
    CALL_BUILTIN_FAST=149,
    CALL_BUILTIN_FAST_WITH_KEYWORDS=150,
    CALL_BUILTIN_O=151,
    CALL_EX_NON_PY_GENERAL=152,
    CALL_EX_PY=153,
    CALL_ISINSTANCE=154,
    CALL_KW_BOUND_METHOD=155,
    CALL_KW_NON_PY=156,
    CALL_KW_PY=157,
    CALL_LEN=158,
    CALL_LIST_APPEND=159,
    ...
    RESUME_CHECK=198,
    RESUME_CHECK_JIT=199,
    SEND_GEN=200,
    STORE_ATTR_INSTANCE_VALUE=201,
    STORE_ATTR_SLOT=202,
    STORE_ATTR_WITH_HINT=203,
    STORE_SUBSCR_DICT=204,
    STORE_SUBSCR_LIST_INT=205,
    TO_BOOL_ALWAYS_TRUE=206,
    TO_BOOL_BOOL=207,
    TO_BOOL_INT=208,
    TO_BOOL_LIST=209,
    TO_BOOL_NONE=210,
