...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_UNPACK_SEQUENCE_UNIQUE_LIST] = HAS_ARG_FLAG,
    ...
    [_CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_CALL_METHOD_DESCRIPTOR_FAST] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
...
const _PyUopCachingInfo _PyUop_Caching[MAX_UOP_ID+1] = {
    ...
    [_UNPACK_SEQUENCE_UNIQUE_LIST] = {
        .best = { 1, 1, 1, 1 },
        .entries = {
            { -1, -1, -1 },
            { 0, 1, _UNPACK_SEQUENCE_UNIQUE_LIST_r10 },
            { -1, -1, -1 },
            { -1, -1, -1 },
        },
    },
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_UNPACK_SEQUENCE_UNIQUE_LIST_r10] = _UNPACK_SEQUENCE_UNIQUE_LIST,
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_UNPACK_SEQUENCE_UNIQUE_LIST] = "_UNPACK_SEQUENCE_UNIQUE_LIST",
    [_UNPACK_SEQUENCE_UNIQUE_LIST_r10] = "_UNPACK_SEQUENCE_UNIQUE_LIST_r10",
