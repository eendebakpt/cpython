...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_ADD_INT_FLOAT] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_ADD_FLOAT_INT] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_SUBTRACT_INT_FLOAT] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_SUBTRACT_FLOAT_INT] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_MULTIPLY_INT_FLOAT] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_MULTIPLY_FLOAT_INT] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
    [_BINARY_OP_ADD_INT_FLOAT_INPLACE] = 0,
    [_BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE] = 0,
    [_BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE] = 0,
    [_BINARY_OP_ADD_FLOAT_INT_INPLACE] = 0,
    [_BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE] = 0,
    [_BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE] = 0,
    ...
    [_LOAD_SUPER_ATTR_METHOD] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_CALL_BUILTIN_CLASS] = HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_BUILTIN_O] = HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_BUILTIN_FAST] = HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_BUILTIN_FAST_WITH_KEYWORDS] = HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
...
const _PyUopCachingInfo _PyUop_Caching[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_ADD_INT_FLOAT] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_ADD_INT_FLOAT_r03 },
            { 3, 1, _BINARY_OP_ADD_INT_FLOAT_r13 },
            { 3, 2, _BINARY_OP_ADD_INT_FLOAT_r23 },
            { -1, -1, -1 },
        },
    },
    ...
    [_BINARY_OP_SUBTRACT_INT_FLOAT] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_SUBTRACT_INT_FLOAT_r03 },
            { 3, 1, _BINARY_OP_SUBTRACT_INT_FLOAT_r13 },
            { 3, 2, _BINARY_OP_SUBTRACT_INT_FLOAT_r23 },
            { -1, -1, -1 },
        },
    },
    ...
    [_BINARY_OP_MULTIPLY_INT_FLOAT] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_MULTIPLY_INT_FLOAT_r03 },
            { 3, 1, _BINARY_OP_MULTIPLY_INT_FLOAT_r13 },
            { 3, 2, _BINARY_OP_MULTIPLY_INT_FLOAT_r23 },
            { -1, -1, -1 },
        },
    },
    ...
    [_BINARY_OP_ADD_INT_FLOAT_INPLACE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_ADD_INT_FLOAT_INPLACE_r03 },
            { 3, 1, _BINARY_OP_ADD_INT_FLOAT_INPLACE_r13 },
            { 3, 2, _BINARY_OP_ADD_INT_FLOAT_INPLACE_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r03 },
            { 3, 1, _BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r13 },
            { 3, 2, _BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r03 },
            { 3, 1, _BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r13 },
            { 3, 2, _BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_ADD_FLOAT_INT_INPLACE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_ADD_FLOAT_INT_INPLACE_r03 },
            { 3, 1, _BINARY_OP_ADD_FLOAT_INT_INPLACE_r13 },
            { 3, 2, _BINARY_OP_ADD_FLOAT_INT_INPLACE_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r03 },
            { 3, 1, _BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r13 },
            { 3, 2, _BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r03 },
            { 3, 1, _BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r13 },
            { 3, 2, _BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r23 },
            { -1, -1, -1 },
        },
    },
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_BINARY_OP_ADD_INT_FLOAT_r03] = _BINARY_OP_ADD_INT_FLOAT,
    [_BINARY_OP_ADD_INT_FLOAT_r13] = _BINARY_OP_ADD_INT_FLOAT,
    [_BINARY_OP_ADD_INT_FLOAT_r23] = _BINARY_OP_ADD_INT_FLOAT,
    ...
    [_BINARY_OP_SUBTRACT_INT_FLOAT_r03] = _BINARY_OP_SUBTRACT_INT_FLOAT,
    [_BINARY_OP_SUBTRACT_INT_FLOAT_r13] = _BINARY_OP_SUBTRACT_INT_FLOAT,
    [_BINARY_OP_SUBTRACT_INT_FLOAT_r23] = _BINARY_OP_SUBTRACT_INT_FLOAT,
    ...
    [_BINARY_OP_MULTIPLY_INT_FLOAT_r03] = _BINARY_OP_MULTIPLY_INT_FLOAT,
    [_BINARY_OP_MULTIPLY_INT_FLOAT_r13] = _BINARY_OP_MULTIPLY_INT_FLOAT,
    [_BINARY_OP_MULTIPLY_INT_FLOAT_r23] = _BINARY_OP_MULTIPLY_INT_FLOAT,
    ...
    [_BINARY_OP_ADD_INT_FLOAT_INPLACE_r03] = _BINARY_OP_ADD_INT_FLOAT_INPLACE,
    [_BINARY_OP_ADD_INT_FLOAT_INPLACE_r13] = _BINARY_OP_ADD_INT_FLOAT_INPLACE,
    [_BINARY_OP_ADD_INT_FLOAT_INPLACE_r23] = _BINARY_OP_ADD_INT_FLOAT_INPLACE,
    [_BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r03] = _BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE,
    [_BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r13] = _BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE,
    [_BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r23] = _BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE,
    [_BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r03] = _BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE,
    [_BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r13] = _BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE,
    [_BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r23] = _BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE,
    [_BINARY_OP_ADD_FLOAT_INT_INPLACE_r03] = _BINARY_OP_ADD_FLOAT_INT_INPLACE,
    [_BINARY_OP_ADD_FLOAT_INT_INPLACE_r13] = _BINARY_OP_ADD_FLOAT_INT_INPLACE,
    [_BINARY_OP_ADD_FLOAT_INT_INPLACE_r23] = _BINARY_OP_ADD_FLOAT_INT_INPLACE,
    [_BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r03] = _BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE,
    [_BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r13] = _BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE,
    [_BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r23] = _BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE,
    [_BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r03] = _BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE,
    [_BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r13] = _BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE,
    [_BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r23] = _BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE,
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_BINARY_OP_ADD_FLOAT_INT_INPLACE] = "_BINARY_OP_ADD_FLOAT_INT_INPLACE",
    [_BINARY_OP_ADD_FLOAT_INT_INPLACE_r03] = "_BINARY_OP_ADD_FLOAT_INT_INPLACE_r03",
    [_BINARY_OP_ADD_FLOAT_INT_INPLACE_r13] = "_BINARY_OP_ADD_FLOAT_INT_INPLACE_r13",
    [_BINARY_OP_ADD_FLOAT_INT_INPLACE_r23] = "_BINARY_OP_ADD_FLOAT_INT_INPLACE_r23",
    ...
    [_BINARY_OP_ADD_INT_FLOAT] = "_BINARY_OP_ADD_INT_FLOAT",
    [_BINARY_OP_ADD_INT_FLOAT_r03] = "_BINARY_OP_ADD_INT_FLOAT_r03",
    [_BINARY_OP_ADD_INT_FLOAT_r13] = "_BINARY_OP_ADD_INT_FLOAT_r13",
    [_BINARY_OP_ADD_INT_FLOAT_r23] = "_BINARY_OP_ADD_INT_FLOAT_r23",
    [_BINARY_OP_ADD_INT_FLOAT_INPLACE] = "_BINARY_OP_ADD_INT_FLOAT_INPLACE",
    [_BINARY_OP_ADD_INT_FLOAT_INPLACE_r03] = "_BINARY_OP_ADD_INT_FLOAT_INPLACE_r03",
    [_BINARY_OP_ADD_INT_FLOAT_INPLACE_r13] = "_BINARY_OP_ADD_INT_FLOAT_INPLACE_r13",
    [_BINARY_OP_ADD_INT_FLOAT_INPLACE_r23] = "_BINARY_OP_ADD_INT_FLOAT_INPLACE_r23",
    ...
    [_BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE] = "_BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE",
    [_BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r03] = "_BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r03",
    [_BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r13] = "_BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r13",
    [_BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r23] = "_BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r23",
    ...
    [_BINARY_OP_MULTIPLY_INT_FLOAT] = "_BINARY_OP_MULTIPLY_INT_FLOAT",
    [_BINARY_OP_MULTIPLY_INT_FLOAT_r03] = "_BINARY_OP_MULTIPLY_INT_FLOAT_r03",
    [_BINARY_OP_MULTIPLY_INT_FLOAT_r13] = "_BINARY_OP_MULTIPLY_INT_FLOAT_r13",
    [_BINARY_OP_MULTIPLY_INT_FLOAT_r23] = "_BINARY_OP_MULTIPLY_INT_FLOAT_r23",
    [_BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE] = "_BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE",
    [_BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r03] = "_BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r03",
    [_BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r13] = "_BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r13",
    [_BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r23] = "_BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r23",
    ...
    [_BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE] = "_BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE",
    [_BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r03] = "_BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r03",
    [_BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r13] = "_BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r13",
    [_BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r23] = "_BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r23",
    ...
    [_BINARY_OP_SUBTRACT_INT_FLOAT] = "_BINARY_OP_SUBTRACT_INT_FLOAT",
    [_BINARY_OP_SUBTRACT_INT_FLOAT_r03] = "_BINARY_OP_SUBTRACT_INT_FLOAT_r03",
    [_BINARY_OP_SUBTRACT_INT_FLOAT_r13] = "_BINARY_OP_SUBTRACT_INT_FLOAT_r13",
    [_BINARY_OP_SUBTRACT_INT_FLOAT_r23] = "_BINARY_OP_SUBTRACT_INT_FLOAT_r23",
    [_BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE] = "_BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE",
    [_BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r03] = "_BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r03",
    [_BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r13] = "_BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r13",
    [_BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r23] = "_BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r23",
...
int _PyUop_num_popped(int opcode, int oparg)
{
    switch(opcode) {
        ...
        case _BINARY_OP_SUBTRACT_FLOAT:
            return 2;
        case _BINARY_OP_ADD_INT_FLOAT:
            return 2;
        case _BINARY_OP_ADD_FLOAT_INT:
            return 2;
        case _BINARY_OP_SUBTRACT_INT_FLOAT:
            return 2;
        case _BINARY_OP_SUBTRACT_FLOAT_INT:
            return 2;
        case _BINARY_OP_MULTIPLY_INT_FLOAT:
            return 2;
