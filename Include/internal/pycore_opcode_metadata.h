...
int _PyOpcode_num_popped(int opcode, int oparg)  {
    switch(opcode) {
        ...
        case LOAD_ATTR_METHOD_LAZY_DICT:
            return 1;
        case LOAD_ATTR_METHOD_LAZY_DICT_BOUND:
            return 1;
        case LOAD_ATTR_METHOD_NO_DICT:
            return 1;
        case LOAD_ATTR_METHOD_NO_DICT_BOUND:
            return 1;
        case LOAD_ATTR_METHOD_WITH_VALUES:
            return 1;
        case LOAD_ATTR_METHOD_WITH_VALUES_BOUND:
            return 1;
...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [LOAD_ATTR_METHOD_LAZY_DICT_BOUND] = { true, INSTR_FMT_IBC00000000, HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_RECORDS_VALUE_FLAG },
    [LOAD_ATTR_METHOD_NO_DICT] = { true, INSTR_FMT_IBC00000000, HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_RECORDS_VALUE_FLAG },
    [LOAD_ATTR_METHOD_NO_DICT_BOUND] = { true, INSTR_FMT_IBC00000000, HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_RECORDS_VALUE_FLAG },
    [LOAD_ATTR_METHOD_WITH_VALUES] = { true, INSTR_FMT_IBC00000000, HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_RECORDS_VALUE_FLAG },
    [LOAD_ATTR_METHOD_WITH_VALUES_BOUND] = { true, INSTR_FMT_IBC00000000, HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_RECORDS_VALUE_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [LOAD_ATTR_METHOD_LAZY_DICT_BOUND] = { .nuops = 4, .uops = { { _RECORD_TOS_TYPE, OPARG_SIMPLE, 1 }, { _GUARD_TYPE_VERSION, 2, 1 }, { _CHECK_ATTR_METHOD_LAZY_DICT, 1, 3 }, { _LOAD_ATTR_METHOD_BOUND, 4, 5 } } },
    ...
    [LOAD_ATTR_METHOD_NO_DICT_BOUND] = { .nuops = 3, .uops = { { _RECORD_TOS_TYPE, OPARG_SIMPLE, 1 }, { _GUARD_TYPE_VERSION, 2, 1 }, { _LOAD_ATTR_METHOD_BOUND, 4, 5 } } },
    ...
    [LOAD_ATTR_METHOD_WITH_VALUES_BOUND] = { .nuops = 4, .uops = { { _RECORD_TOS_TYPE, OPARG_SIMPLE, 1 }, { _GUARD_TYPE_VERSION, 2, 1 }, { _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT, OPARG_SIMPLE, 3 }, { _LOAD_ATTR_METHOD_BOUND, 4, 5 } } },
...
const char *_PyOpcode_OpName[267] = {
    ...
    [LOAD_ATTR_METHOD_LAZY_DICT_BOUND] = "LOAD_ATTR_METHOD_LAZY_DICT_BOUND",
    [LOAD_ATTR_METHOD_NO_DICT] = "LOAD_ATTR_METHOD_NO_DICT",
    [LOAD_ATTR_METHOD_NO_DICT_BOUND] = "LOAD_ATTR_METHOD_NO_DICT_BOUND",
    [LOAD_ATTR_METHOD_WITH_VALUES] = "LOAD_ATTR_METHOD_WITH_VALUES",
    [LOAD_ATTR_METHOD_WITH_VALUES_BOUND] = "LOAD_ATTR_METHOD_WITH_VALUES_BOUND",
...
const uint8_t _PyOpcode_Deopt[256] = {
    ...
    [LOAD_ATTR_METHOD_LAZY_DICT_BOUND] = LOAD_ATTR,
    [LOAD_ATTR_METHOD_NO_DICT] = LOAD_ATTR,
    [LOAD_ATTR_METHOD_NO_DICT_BOUND] = LOAD_ATTR,
    [LOAD_ATTR_METHOD_WITH_VALUES] = LOAD_ATTR,
    [LOAD_ATTR_METHOD_WITH_VALUES_BOUND] = LOAD_ATTR,
