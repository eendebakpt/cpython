...
int _PyOpcode_num_popped(int opcode, int oparg)  {
    switch(opcode) {
        ...
        case LOAD_FAST_BORROW:
            return 0;
        case LOAD_FAST_BORROW_LOAD_CONST:
            return 0;
        case LOAD_FAST_BORROW_LOAD_FAST_BORROW:
            return 0;
        case LOAD_FAST_BORROW_LOAD_SMALL_INT:
            return 0;
...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [LOAD_FAST_BORROW_LOAD_CONST] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_CONST_FLAG | HAS_LOCAL_FLAG },
    [LOAD_FAST_BORROW_LOAD_FAST_BORROW] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_LOCAL_FLAG },
    [LOAD_FAST_BORROW_LOAD_SMALL_INT] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_LOCAL_FLAG },
    [LOAD_FAST_CHECK] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ERROR_FLAG },
    [LOAD_FAST_LOAD_CONST] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_CONST_FLAG | HAS_LOCAL_FLAG },
    [LOAD_FAST_LOAD_FAST] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_LOCAL_FLAG },
    [LOAD_FAST_LOAD_SMALL_INT] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_LOCAL_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [LOAD_FAST_BORROW_LOAD_CONST] = { .nuops = 2, .uops = { { _LOAD_FAST_BORROW, OPARG_TOP, 0 }, { _LOAD_CONST, OPARG_BOTTOM, 0 } } },
    [LOAD_FAST_BORROW_LOAD_FAST_BORROW] = { .nuops = 2, .uops = { { _LOAD_FAST_BORROW, OPARG_TOP, 0 }, { _LOAD_FAST_BORROW, OPARG_BOTTOM, 0 } } },
    [LOAD_FAST_BORROW_LOAD_SMALL_INT] = { .nuops = 2, .uops = { { _LOAD_FAST_BORROW, OPARG_TOP, 0 }, { _LOAD_SMALL_INT, OPARG_BOTTOM, 0 } } },
    [LOAD_FAST_CHECK] = { .nuops = 1, .uops = { { _LOAD_FAST_CHECK, OPARG_SIMPLE, 0 } } },
    [LOAD_FAST_LOAD_CONST] = { .nuops = 2, .uops = { { _LOAD_FAST, OPARG_TOP, 0 }, { _LOAD_CONST, OPARG_BOTTOM, 0 } } },
    [LOAD_FAST_LOAD_FAST] = { .nuops = 2, .uops = { { _LOAD_FAST, OPARG_TOP, 0 }, { _LOAD_FAST, OPARG_BOTTOM, 0 } } },
    [LOAD_FAST_LOAD_SMALL_INT] = { .nuops = 2, .uops = { { _LOAD_FAST, OPARG_TOP, 0 }, { _LOAD_SMALL_INT, OPARG_BOTTOM, 0 } } },
...
const char *_PyOpcode_OpName[267] = {
    ...
    [LOAD_FAST_BORROW_LOAD_CONST] = "LOAD_FAST_BORROW_LOAD_CONST",
    [LOAD_FAST_BORROW_LOAD_FAST_BORROW] = "LOAD_FAST_BORROW_LOAD_FAST_BORROW",
    [LOAD_FAST_BORROW_LOAD_SMALL_INT] = "LOAD_FAST_BORROW_LOAD_SMALL_INT",
    [LOAD_FAST_CHECK] = "LOAD_FAST_CHECK",
    [LOAD_FAST_LOAD_CONST] = "LOAD_FAST_LOAD_CONST",
    [LOAD_FAST_LOAD_FAST] = "LOAD_FAST_LOAD_FAST",
    [LOAD_FAST_LOAD_SMALL_INT] = "LOAD_FAST_LOAD_SMALL_INT",
