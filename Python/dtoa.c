...
/* NOTE: _Py_dg_strtod() and its helper functions (s2b, hi0bits,
 * lo0bits, b2d, sd2b, ratio, dshift, quorem, sulp, bigcomp, BCinfo)
 * have been removed.  String->double conversion is now handled by
 * _PyWuffs_strtod() in Python/_ryu/pystrtod_wuffs.h.
 */
