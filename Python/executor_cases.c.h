...
#define TIER_TWO 2
        ...
        case _BINARY_OP_ADD_INT_FLOAT_r03: {
            CHECK_CURRENT_CACHED_VALUES(0);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_ADD_INT_FLOAT_r13: {
            CHECK_CURRENT_CACHED_VALUES(1);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_ADD_INT_FLOAT_r23: {
            CHECK_CURRENT_CACHED_VALUES(2);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_SUBTRACT_INT_FLOAT_r03: {
            CHECK_CURRENT_CACHED_VALUES(0);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_SUBTRACT_INT_FLOAT_r13: {
            CHECK_CURRENT_CACHED_VALUES(1);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_SUBTRACT_INT_FLOAT_r23: {
            CHECK_CURRENT_CACHED_VALUES(2);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_MULTIPLY_INT_FLOAT_r03: {
            CHECK_CURRENT_CACHED_VALUES(0);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_MULTIPLY_INT_FLOAT_r13: {
            CHECK_CURRENT_CACHED_VALUES(1);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_MULTIPLY_INT_FLOAT_r23: {
            CHECK_CURRENT_CACHED_VALUES(2);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_ADD_INT_FLOAT_INPLACE_r03: {
            CHECK_CURRENT_CACHED_VALUES(0);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_ADD_INT_FLOAT_INPLACE_r13: {
            CHECK_CURRENT_CACHED_VALUES(1);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_ADD_INT_FLOAT_INPLACE_r23: {
            CHECK_CURRENT_CACHED_VALUES(2);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r03: {
            CHECK_CURRENT_CACHED_VALUES(0);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r13: {
            CHECK_CURRENT_CACHED_VALUES(1);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_SUBTRACT_INT_FLOAT_INPLACE_r23: {
            CHECK_CURRENT_CACHED_VALUES(2);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r03: {
            CHECK_CURRENT_CACHED_VALUES(0);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r13: {
            CHECK_CURRENT_CACHED_VALUES(1);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_MULTIPLY_INT_FLOAT_INPLACE_r23: {
            CHECK_CURRENT_CACHED_VALUES(2);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_ADD_FLOAT_INT_INPLACE_r03: {
            CHECK_CURRENT_CACHED_VALUES(0);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_ADD_FLOAT_INT_INPLACE_r13: {
            CHECK_CURRENT_CACHED_VALUES(1);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_ADD_FLOAT_INT_INPLACE_r23: {
            CHECK_CURRENT_CACHED_VALUES(2);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r03: {
            CHECK_CURRENT_CACHED_VALUES(0);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r13: {
            CHECK_CURRENT_CACHED_VALUES(1);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_SUBTRACT_FLOAT_INT_INPLACE_r23: {
            CHECK_CURRENT_CACHED_VALUES(2);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r03: {
            CHECK_CURRENT_CACHED_VALUES(0);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r13: {
            CHECK_CURRENT_CACHED_VALUES(1);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
        ...
        case _BINARY_OP_MULTIPLY_FLOAT_INT_INPLACE_r23: {
            CHECK_CURRENT_CACHED_VALUES(2);
            assert(WITHIN_STACK_BOUNDS_IGNORING_CACHE());
            _PyStackRef right;
            _PyStackRef left;
