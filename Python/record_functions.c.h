...
const _PyOpcodeRecordEntry _PyOpcode_RecordEntries[256] = {
        ...
        [LOAD_ATTR_METHOD_WITH_VALUES_BOUND] = {1, {_RECORD_TOS_INDEX}},
        [LOAD_ATTR_METHOD_NO_DICT_BOUND] = {1, {_RECORD_TOS_INDEX}},
        [LOAD_ATTR_METHOD_LAZY_DICT_BOUND] = {1, {_RECORD_TOS_INDEX}},
...
const _PyOpcodeRecordSlotMap _PyOpcode_RecordSlotMaps[256] = {
        ...
        [LOAD_ATTR_METHOD_WITH_VALUES_BOUND] = {1, 1, {0}},
        [LOAD_ATTR_METHOD_NO_DICT_BOUND] = {1, 1, {0}},
        [LOAD_ATTR_METHOD_LAZY_DICT_BOUND] = {1, 1, {0}},
